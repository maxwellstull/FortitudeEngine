...
void MenuManager::TowerShop()
{
	...
	t2->onEnter([this]() {this->GetEngine()->setMouseToDrag(); this->GetEngine()->getGame()->getTowerManager()->spawnMarshall(); });
	...
	std::shared_ptr<MenuShopItem> t4 = std::make_shared<MenuShopItem>("Prospector", fonts[0], sf::IntRect(1795, 370, 100, 100), 32, GetEngine()->getGame()->getTowerTexture(4), sf::Vector2f(50, 90));
	t4->onSelect(sf::Color::Blue, 48, 0.25);
	t4->setControlBind(2, 6, 5, 5);
	t4->onEnter([this]() {this->GetEngine()->setMouseToDrag(); this->GetEngine()->getGame()->getTowerManager()->spawnProspector(); });
	t4->setFillColor(sf::Color(107, 107, 107));
	t4->setSpriteScale(0.25, 0.25);
	t4->setSpriteRotation(45);
	std::shared_ptr<MenuShopItem> t5 = std::make_shared<MenuShopItem>("Blaster", fonts[0], sf::IntRect(1645, 520, 100, 100), 32, GetEngine()->getGame()->getTowerTexture(5), sf::Vector2f(50, 90));
	t5->onSelect(sf::Color::Blue, 48, 0.25);
	t5->setControlBind(3, 7, 6, 6);
	t5->onEnter([this]() {this->GetEngine()->setMouseToDrag(); this->GetEngine()->getGame()->getTowerManager()->spawnBlaster(); });
	...
	std::shared_ptr<MenuShopItem> t7 = std::make_shared<MenuShopItem>("Doc", fonts[0], sf::IntRect(1645, 670, 100, 100), 32, GetEngine()->getGame()->getTowerTexture(9), sf::Vector2f(50, 90));
	t7->onSelect(sf::Color::Blue, 48, 0.25);
	t7->setControlBind(5, 1, 8, 8);
	t7->onEnter([this]() {this->GetEngine()->setMouseToDrag(); this->GetEngine()->getGame()->getTowerManager()->spawnDoc(); });
